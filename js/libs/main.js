    ...
    Popcorn.xhr({
        ...
        success: function(data) {
            ...
            for(var i = 0; i<data.results.bindings.length; i++) {
                //console.log(data.results.bindings[i].Artist.value + ", Zeit: " + convertTime(data.results.bindings[i].TimeIn.value) + ", " + convertTime(data.results.bindings[i].TimeOut.value));
                console.log(convertTime(data.results.bindings[i].TimeIn.value));
                popcorn.footnote({
